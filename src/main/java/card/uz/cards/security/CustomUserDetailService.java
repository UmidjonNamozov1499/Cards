package card.uz.cards.security;

import card.uz.cards.entity.Authority;
...
public class CustomUserDetailService implements UserDetailsService {
    ...
    private User createSpringSecurityUser(String username, card.uz.cards.entity.User user) {
        if (!user.isActivated()) {
